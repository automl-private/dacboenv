...
def main(cfg: DictConfig) -> None:
    ...
    task = make_task(cfg)
    len_episode = cfg.task.optimization_resources.n_trials
    ...
    model: BaseAlgorithm = instantiate(cfg.optimizer)(
        policy=PerceptronPolicy, env=vec_env, policy_kwargs=policy_kwargs, tensorboard_log=rundir / "tensorboard"
    )
